...
export default function PrintPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 p-4 max-w-4xl mx-auto drop-shadow-2xl">
      ...
      <Card className="flex-1 p-4">
        <div className="space-y-4">
          ...
          <Button onClick={handlePrint} className="w-full bg-blue-600 ">
    ...
    <path d="M17 8V6C17 4.11438 17 3.17157 16.4142 2.58579C15.8284 2 14.8856 2 13 2H11C9.11438 2 8.17157 2 7.58579 2.58579C7 3.17157 7 4.11438 7 6V8" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
