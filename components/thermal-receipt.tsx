...
export default function ThermalReceipt() {
  ...
  const handlePhoneChange = (e) => {
    ...
    const formattedPhone = value.replace(
      /^(\d{2})(\d{5})(\d{0,4})$/,
      (_, ddd, firstPart, secondPart) => `(${ddd}) ${firstPart}${secondPart ? `-${secondPart}` : ''}`
    )
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 p-4 max-w-4xl mx-auto">
      ...
      <Card className="flex-1 p-4">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="message" className='font-bold'>Mensagem publicitária</Label>
            <Textarea
              id="message"
          ...
          <div className="space-y-2">
            <Label htmlFor="phone" className='font-bold'>Telefone ou WhatsApp</Label>
            <Input
              id="phone"
          ...
          <div className="space-y-2">
            <Label htmlFor="name" className='font-bold'>Estabelecimento</Label>
            <Input
              id="name"
              value={formData.name}
    ...
    <path d="M18 12H18.009" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      ...
      {/* Preview Section */}
      <Card className="flex-1 p-4">
        <div className="text-center mb-4">Pré Vis</div>
